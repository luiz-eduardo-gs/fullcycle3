...
import (
	...
	application "github.com/luiz-eduardo-gs/go-hexagonal/application"
)
...
func (m *MockProductServiceInterface) Create(id string, price float64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) Create(id, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductServiceInterface)(nil).Create), id, price)
}
